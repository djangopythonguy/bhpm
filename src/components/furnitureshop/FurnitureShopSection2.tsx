...
import { Paragraph, H3, H6, H1 } from "components/Typography";
...
const LeftContentBox = styled(Box)<{ imgUrl: string }>(({ theme, imgUrl }) => ({
  ...boxStyle,
...
const RightContentBox = styled(Box)<{ imgUrl: string }>(
  ({ theme, imgUrl }) => ({
    ...boxStyle,
    display: "block",
    background: theme.palette.primary[50],
...
const FurnitureShopSection2: FC = () => {
